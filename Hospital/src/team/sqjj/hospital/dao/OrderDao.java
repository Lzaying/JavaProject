...
public interface OrderDAO {
	public int addOrder(int drugId, String patientId, String id, String doctorName, String department, String drugName,
			int quantity, String unit, int price, String code, int isPaid);// 业务层中先要查询出完全的药品信息，在此添加
