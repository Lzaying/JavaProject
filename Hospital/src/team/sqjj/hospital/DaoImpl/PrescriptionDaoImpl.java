...
public class PrescriptionDaoImpl implements PrescriptionDao{
    ...
    public int addPrescription(Prescription prescription){
    	int i=0;
		try{
			String sql="insert into Prescription values("+prescription.getDrug_Id()+",'"+prescription.getPatient_Id()+"','"+prescription.getDoctor_Id()+"',"+prescription.getTotalPrice()+","+prescription.getIsPaid()+")";
